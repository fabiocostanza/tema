...
$masonry_layout = HubitatOptions::get_global( 'woocommerce_masonry_layout', true );
...
$double_width = HubitatOptions::get_local( 'product_style_in_grid' );
...
$hover_effect = HubitatOptions::get_global( 'shop_item_hover_type' );
$parallax_class = "";
...
$show_price = HubitatOptions::get_global( 'woocommerce_shop_price_visibility' );
$show_category = HubitatOptions::get_global( 'woocommerce_shop_category_visibility' );
$use_boxed_layout = HubitatOptions::get_global( 'product_items_boxed_style' );
if ( $use_boxed_layout ) {
...
if ( $masonry_layout ) {
	...
	$columns_num = HubitatOptions::get_global( 'woocommerce_products_on_page', 24 );
	...
	$_anim_attrs = HubitatHelper::get_AOS_animation_attrs( $animation_type, $animation_effect, (int) substr( $products_in_row->large, 0, 1), $iteration );
}

$photos_count = HubitatOptions::get_global( 'woocommerce_product_images_count', 2 );
$text_align = HubitatOptions::get_global( 'woocommerce_text_alignment', 'left' );
$quickview_btn = HubitatOptions::get_global( 'woocommerce_quickview_button', true );
