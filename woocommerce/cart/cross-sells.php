...
$products_in_row = HubitatSettings::get( 'woocommerce_products_in_row', 'global' );
...
if ( $cross_sells ) : ?>
	...
	<div class="cross-sells woo-c_cross_sells">
		<h4 class="heading-md">
			<?php
			$heading = apply_filters( 'woocommerce_product_cross_sells_products_heading', __( 'You may be interested in', 'hubitat' ) );
