		...
		switch ( $pagination_type ) {
			case 'simple':
				$paginate = paginate_links( apply_filters( 'woocommerce_pagination_args', array(
					...
					'total'        => $total,
					'prev_text'    => '<span class="btn btn-link"><i class="ion-left ion ion-md-arrow-back"></i> ' . esc_html__( 'Prev', 'hubitat' ) . '</span>',
					'next_text'    => '<span class="btn btn-link">' . esc_html__( 'Next', 'hubitat' ) . '  <i class="ion-right ion ion-md-arrow-forward"></i></span>',
					'type'         => 'list',
					'end_size'     => 3,
					'mid_size'     => 3,
				) ) );
