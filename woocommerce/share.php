...
<div class="yith-wcwl-share">
    ...
    <ul class="socialbar small">
        <?php if( $share_facebook_enabled ): ?>
            <li class="share-button">
                <a target="_blank" class="facebook" href="https://www.facebook.com/sharer.php?u=<?php echo urlencode($share_link_url)?>&p[title]=<?php echo $share_link_title ?>" title="<?php _e( 'Facebook', 'hubitat' ) ?>">
                    <?php echo $share_facebook_icon ? '<i class="fab fa-facebook-f"></i>' : __( 'Facebook', 'hubitat' ) ?>
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if( $share_twitter_enabled ): ?>
            <li class="share-button">
                <a target="_blank" class="twitter" href="https://twitter.com/share?url=<?php echo urlencode( $share_link_url ) ?>&amp;text=<?php echo $share_twitter_summary ?>" title="<?php _e( 'Twitter', 'hubitat' ) ?>">
	                <?php echo $share_twitter_icon ? '<i class="fab fa-twitter"></i>' : __( 'Twitter', 'hubitat' ) ?>
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if( $share_pinterest_enabled ): ?>
            <li class="share-button">
                <a target="_blank" class="pinterest" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode( $share_link_url ) ?>&amp;description=<?php echo $share_summary ?>&amp;media=<?php echo $share_image_url ?>" title="<?php _e( 'Pinterest', 'hubitat' ) ?>" onclick="window.open(this.href); return false;">
	                <?php echo $share_pinterest_icon ? '<i class="fab fa-pinterest"></i>' : __( 'Pinterest', 'hubitat' ) ?>
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if( $share_email_enabled ): ?>
            <li class="share-button">
                <a class="email" href="mailto:?subject=<?php echo urlencode( apply_filters( 'yith_wcwl_email_share_subject', $share_link_title ) )?>&amp;body=<?php echo apply_filters( 'yith_wcwl_email_share_body', urlencode( $share_link_url ) ) ?>&amp;title=<?php echo $share_link_title ?>" title="<?php _e( 'Email', 'hubitat' ) ?>">
	                <?php echo $share_email_icon ? '<i class="fa fa-envelope"></i>' : __( 'Email', 'hubitat' ) ?>
                </a>
            </li>
        <?php endif; ?>
        ...
        <?php if( $share_whatsapp_enabled ):
            ?>
            <li class="share-button">
                <a class="whatsapp" href="<?php echo $share_whatsapp_url ?>" data-action="share/whatsapp/share" target="_blank" title="<?php _e( 'WhatsApp', 'hubitat' ) ?>">
	                <?php echo $share_whatsapp_icon ? '<i class="fab fa-whatsapp"></i>' : __( 'Whatsapp', 'hubitat' ) ?>
                </a>
            </li>
        <?php endif;
        ?>
    ...
    <?php if( $share_url_enabled ): ?>
        <div class="yith-wcwl-after-share-section">
            ...
            <?php echo ( ! empty( $share_link_url ) ) ? sprintf( '<small>%s <span class="copy-trigger">%s</span> %s</small>', __( '(Now', 'hubitat' ), __( 'copy', 'hubitat' ), __( 'this wishlist link and share it anywhere)', 'hubitat' ) ) : '' ?>
        </div>
    <?php endif; ?>
