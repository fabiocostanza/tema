...
<form class="woo_c-product-details-variations cart woocommerce-add-to-cart" method="post" enctype='multipart/form-data'>
	<?php if ( $product->is_in_stock() ) : ?>
		...
		<div class="simple-qty">
			<div class="label">
				<label for="quantity"><?php esc_html_e( 'Quantity', 'hubitat' ); ?>:</label>
			</div>
	...
	<?php else: ?>
		<div class="single_add_to_cart_button out_of_stock">
			<div class="hubitat-message-module-sc message-box error"><?php esc_html_e( 'This product is currently out of stock and unavailable.', 'hubitat' ); ?></div>
		</div>
	<?php endif; ?>
</form>
