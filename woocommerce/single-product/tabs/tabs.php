...
if ( ! empty( $tabs ) ) : ?>
            ...
            <div class="woocommerce  page-container single-product-tabs">
                <div class="tab" data-hubitat-tab-box="true" id="product_review">
                    <div class="tabNav_wrapper">
                        <ul class="tabNav" role="tablist">
                            ...
                            foreach ( $tabs as $key => $tab ) : ?>
                                <li class="tabNav_link <?php echo esc_attr($i == 0 ? ' active' : '' )?>" data-hubitat-tab="<?php echo esc_attr( $key ) ?>">
                    ...
                    <div data-vc-full-width="true" data-vc-full-width-init="true" class="vc_row tab-items-container">
                        <div class="tabItems">
                            ...
                            $i = 0;
                            foreach ( $tabs as $key => $tab ) : ?>
                                <div class="tabItems_item<?php echo esc_attr($i == 0 ? ' active' : '') ?>" data-hubitat-tab-content="<?php echo esc_attr( $key )?>">
                                    <div class="wrap">
