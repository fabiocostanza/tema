<?php
    ...
    $category_in_breadcrumb = HubitatOptions::get( 'page_show_category_breadcrumbs', true );
?>
        ...
        <ol class="breadcrumbs-slug" itemscope itemtype="http://schema.org/BreadcrumbList">
            ...
            <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                <a class="brand-color-hover" itemprop="item" href="<?php echo esc_url( get_permalink( wc_get_page_id( 'shop' ) ) ); ?>">
                    <span itemprop="name"><?php echo HubitatSettings::breadcrumbs_woocommerce_slug(); ?></span>
                </a>
