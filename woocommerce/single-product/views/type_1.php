...
$show_lightbox = HubitatOptions::get_global( 'woocommerce_product_lightbox_preview' );
$image_zoom = HubitatOptions::get_global( 'woocommerce_product_zoom', 'top' );
...
<div class="page-container" >
    ...
    <div class="vc_row" id="scroll-product">
        <div class="vc_col-md-7 vc_col-sm-12 woo_c-product-image <?php echo $image_zoom ? esc_attr('with-zoom') : '' ?>">
            <div class="woo_c-product-image-slider hubitat-gallery-sc gallery-wrap" data-gallery="hubitat-custom-<?php echo esc_attr( $product->get_id()); ?>">
                <?php if ( has_post_thumbnail() ) { ?>
                    ...
                    echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), esc_html__( 'Placeholder', 'hubitat' ) ), $post->ID );
                } ?>
                <?php wc_get_template_part('single-product/sale', 'stick'); ?>
                <?php $show_sharing = HubitatOptions::get_global( 'woocommerce_sharing_visibility' );
                    if ( $show_sharing ) {
                        do_shortcode( '[hubitat_share_woo]' );
                } ?>
        ...
        <div class="vc_col-md-5 vc_col-sm-12 woo_c-product-details">
            <div class="summary entry-summary woo_c-product-details-inner" data-hubitat-content-scroll='#scroll-product'>
    ...
    <div class="hubitat-gallery-opened-sc clb-popup clb-gallery-lightbox" id="hubitat-custom-<?php echo esc_attr( $product->get_id()); ?>">
