...
<ul class="woo-c_wishlist shop_table cart wishlist_table wishlist_view responsive mobile <?php echo $show_cb ? 'with-checkbox' : '' ?>" data-pagination="<?php echo esc_attr( $pagination )?>" data-per-page="<?php echo esc_attr( $per_page )?>" data-page="<?php echo esc_attr( $current_page )?>" data-id="<?php echo $wishlist_id ?>" data-token="<?php echo $wishlist_token ?>">
    ...
    if( $wishlist && $wishlist->has_items() ) :
                        ...
                        <?php if( $show_quantity || $show_stock_status ): ?>
                            <table class="additional-info">
	                            ...
	                            <?php if( $show_stock_status ) : ?>
                                    <tr>
                                        <td class="label">
                                            <?php _e( 'Stock:', 'hubitat' ) ?>
                                        </td>
                                        <td class="value">
                                            <?php echo $stock_status == 'out-of-stock' ? '<span class="wishlist-out-of-stock">' . __( 'Out of stock', 'hubitat' ) . '</span>' : '<span class="wishlist-in-stock">' . __( 'In Stock', 'hubitat' ) . '</span>'; ?>
                                        </td>
                                    </tr>
	                            <?php endif ?>
                            </table>
        ...
        <p class="wishlist-empty">
            <?php echo apply_filters( 'yith_wcwl_no_product_to_remove_message', __( 'No products added to the wishlist', 'hubitat' ) ) ?>
        </p>
    <?php
    endif;
