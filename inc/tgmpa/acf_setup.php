...
function hubitat_acf_json_load_point( $paths ) {
...
// add_filter('acf/settings/load_json', 'hubitat_acf_json_load_point');
...
if ( function_exists( 'acf_add_options_page' ) && function_exists( 'acf_add_options_sub_page' ) ) {
	...
	// 	'page_title' => esc_html__( 'Hubitat Theme Settings', 'hubitat' ),
	// 	'menu_title' => esc_html__( 'Theme Settings', 'hubitat' ),
	...
	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Pages Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Site Identity', 'hubitat' ),
		'menu_slug' => 'theme-general',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Pages Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Theme Styling', 'hubitat' ),
	...
	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Pages Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Typography', 'hubitat' ),
		'menu_slug' => 'theme-general-typography',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Header Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Header', 'hubitat' ),
	...
	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Header Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Menu', 'hubitat' ),
	...
	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Pages Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Page Settings', 'hubitat' ),
		'menu_slug' => 'theme-general-pages',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Portfolio Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Portfolio', 'hubitat' ),
		'menu_slug' => 'theme-general-portfolio',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Blog Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Blog', 'hubitat' ),
		'menu_slug' => 'theme-general-blog',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Post Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Single Post', 'hubitat' ),
		'menu_slug' => 'theme-general-post',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme WooCommerce Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Shop', 'hubitat' ),
		'menu_slug' => 'theme-general-woocommerce',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme WooCommerce Product Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Single Product', 'hubitat' ),
		'menu_slug' => 'theme-general-product',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Footer Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Footer', 'hubitat' ),
	...
	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Blog Settings', 'hubitat' ),
		'menu_title' => esc_html__( 'Custom CSS', 'hubitat' ),
		'menu_slug' => 'theme-general-custom',
		'parent_slug' => '_hubitat_fake'
	));

	acf_add_options_sub_page(array(
		'page_title' => esc_html__( 'Theme Plugins', 'hubitat' ),
		'menu_title' => esc_html__( 'Other', 'hubitat' ),
...
function hubitat_acf_return_default_when_null( $value = NULL, $post_id = NULL, $field = NULL ) {
...
add_filter( 'acf/load_value', 'hubitat_acf_return_default_when_null', 10, 3 );
*/
 ...
 */
// add_action('acf/save_post', 'hubitat_sync_custom_field', 11);

function hubitat_sync_custom_field ( $current_post_id ) {
	$post_ids = [];
...
if( function_exists('acf_add_local_field_group') && function_exists('wc_get_attribute_taxonomy_names') ):
	...
	if ($attribute_terms) {
		...
		acf_add_local_field_group(array (
			'key' => 'hubitatattrsetting',
			'title' => esc_html__('Attribute setting', 'hubitat'),
			'fields' => array (
				array (
					'key' => 'field_hubitatattrsettingselect',
					'label' => 'Mod',
					'name' => 'attribute_mod',
					'type' => 'select',
					'choices' => array(
				...
				array(
					'key'	=> 'field_hubitatattrsettingcolor',
					'label' => 'Choose color',
					'name' => 'color',
					'type' => 'color_picker',
					'conditional_logic'	=> array(
						array(
							array(
								'field' => 'field_hubitatattrsettingselect',
								'operator' => '==',
								'value' => 'color')
							)
						)
...
function hubitat_acf_update_project_slug_value( $value, $post_id, $field ) {
	$value = HubitatHelper::slug_from_string( $value );
	if ( empty( $value ) ) {
		$value = 'project';
	}
...
add_filter('acf/update_value/key=field_59fb4ad44a1dtd336sl', 'hubitat_acf_update_project_slug_value', 10, 3);
