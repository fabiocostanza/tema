<?php if (function_exists('acf_add_local_field_group')) :
    ...
    acf_add_local_field_group([
        ...
        "title" => __('Menu Settings', 'hubitat'),
        "private" => true,
        "fields" => [
            [
            ...
            [
                ...
                "type" => "radio",
                "instructions" => __('Choose menu type for all pages', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "choices" => [
            ...
            [
                ...
                "label" => '<h4>' . __('Standard menu', 'hubitat') . '</h4>',
                "name" => "",
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Standard menu', 'hubitat'),
                "name" => "global_page_extended_menu",
                "type" => "hubitat_menu",
                "instructions" => __('Choose from already pre-made menus', 'hubitat') . '&nbsp;<em>(' . __('Appearance', 'hubitat') . '&nbsp;>&nbsp;' . '<a target="_blank" href="./nav-menus.php">' . __('Menus', 'hubitat') . '</a>)</em>',
                "conditional_logic" => [
                    [
                        [
                            "field" => "field_59229bda3374d",
            ...
            [
                ...
                "label" => __('Standard menu counters', 'hubitat'),
                "name" => "global_page_header_counters_visibility",
                "type" => "true_false",
                "instructions" => __('Show counters on menu items', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Standard menu multi-level indicator', 'hubitat'),
                "name" => "global_page_header_indicator_visibility",
                "type" => "true_false",
                "instructions" => __('Show submenu dropdown multi-level indicators on first level menu items', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Standard menu typography', 'hubitat'),
                "name" => "global_page_header_menu_text_typo",
                "type" => "hubitat_typo",
                "instructions" => __('Set up typography for a standard menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => '<h4>' . __('Hamburger menu', 'hubitat') . '</h4>',
                "name" => "",
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Hamburger menu', 'hubitat'),
            ...
            [
                ...
                "label" => __('Hamburger menu position', 'hubitat'),
                "name" => "global_page_header_menu_position",
                "type" => "select",
                "instructions" => __('Choose a hamburger menu position', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Hamburger menu background', 'hubitat'),
                "name" => "global_page_header_overlay_menu",
                "type" => "clone",
                "instructions" => __('Choose background color for a hamburger menu', 'hubitat'),
                "required" => false,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Hamburger menu details', 'hubitat'),
                "name" => "global_page_overlay_menu_footer_items_left",
                "type" => "repeater",
                "instructions" => __('Add details for the hamburger menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __('Show social networks in a hamburger menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Language switcher', 'hubitat'),
                "name" => "global_page_hamburger_lang_switcher_visibility",
                "type" => "true_false",
                "instructions" => __('Show language switcher in a hamburger menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Hamburger menu typography', 'hubitat'),
                "name" => "global_page_fullscreen_menu_text_typo",
                "type" => "hubitat_typo",
                "instructions" => __('Set up typography for a hamburger menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Mobile menu initial resolution', 'hubitat'),
                "name" => "global_page_mobile_menu_initial_resolution",
                "type" => "number",
                "instructions" => __('Resolution when mobile menu begins to appear', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "default_value" => "768",
                "placeholder" => "",
            ...
            [
                ...
                "label" => __('Mobile menu 1st level items opening', 'hubitat'),
                "name" => "global_page_mobile_second_click_link",
                "type" => "true_false",
                "instructions" => __('Enable opening of the 1st level menu items as regular links', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 0,
            ...
            [
                ...
                "label" => __('Mobile menu color', 'hubitat'),
            ...
            [
                ...
                "label" => __('Mobile menu background', 'hubitat'),
                "name" => "global_page_mobile_header_menu",
                "type" => "clone",
                "instructions" => __('Choose mobile header background', 'hubitat'),
                "required" => false,
            ...
            [
                ...
                "label" => __('Mobile menu hamburger position', 'hubitat'),
                "name" => "global_page_header_mobile_menu_position",
                "type" => "select",
                "instructions" => __('Choose hamburger position for mobile menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "choices" => [
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __('Show social networks in mobile menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 1,
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __('Show search in mobile menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 1,
            ...
            [
                ...
                "label" => __('Mobile menu typography', 'hubitat'),
                "name" => "global_mobile_header_menu_typo",
                "type" => "hubitat_typo",
                "instructions" => __('Set up typography for mobile menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0
            ],
            [
                "key" => "field_5941bd413bs",
                "label" => __('One Page Menu', 'hubitat'),
                "name" => "",
                "type" => "tab",
                "instructions" => "",
                "required" => 0,
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __('Enable one page menu? Handle anchor links as section scroll trigger. Read', 'hubitat') . '&nbsp;<a target="_blank" href="https://docs.wearehubitat.com/hubitat/tips-tricks/#onepage_menu">' . __('the setup guide', 'hubitat') . '</a>',
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 0,
            ...
            [
                ...
                "label" => __('WPML language switcher', 'hubitat'),
                "name" => "global_wpml_show_in_header",
                "type" => "true_false",
                "instructions" => __('Enable WPML language switcher', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 1,
            ...
            [
                ...
                "type" => "true_false",
                "instructions" => __('Show search icon on your website', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 1,
            ...
            [
                ...
                "label" => __('Search type', 'hubitat'),
                "name" => "global_page_header_search_type",
                "type" => "radio",
                "instructions" => __('Choose search type for all pages', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
                ...
                "choices" => [
                    "simple" => __('Standard WordPress', 'hubitat'),
                    "woo" => __('WooCommerce AJAX', 'hubitat')
                ],
                "allow_null" => 0,
                "other_choice" => 0,
                "save_other_choice" => 0,
            ...
            [
                ...
                "type" => "hubitat_color",
                "instructions" => __('Choose color for the fixed search', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => '<h4>' . __('Menu Button', 'hubitat') . '</h4>',
                "name" => "",
                "type" => "message"
            ],
            [
                "key" => "field_592fe13500c39",
                "label" => __('Menu button', 'hubitat'),
                "name" => "global_custom_button_for_header",
                "type" => "true_false",
                "instructions" => __('Enable a custom button in the main menu', 'hubitat'),
                "required" => 0,
                "conditional_logic" => 0,
                "message" => "",
                "default_value" => 0,
            ...
            [
                ...
                "label" => __('Menu button text', 'hubitat'),
                "name" => "global_custom_button_for_header_link",
                "type" => "link",
                "instructions" => __('Set up button options', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Menu button text color', 'hubitat'),
                "name" => "global_custom_button_for_header_color",
                "type" => "hubitat_color",
                "instructions" => __('Choose text color', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
            ...
            [
                ...
                "label" => __('Menu button background', 'hubitat'),
                "name" => "global_custom_button_for_header_background",
                "type" => "hubitat_color",
                "instructions" => __('Choose color for custom button', 'hubitat'),
                "required" => 0,
                "conditional_logic" => [
                    [
                        [
