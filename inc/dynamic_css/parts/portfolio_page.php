...
if ( ! HubitatSettings::page_is( 'projects_page' ) ) {
	return false;
}
...
// Get layout
$projects_layout_item = HubitatOptions::get( 'portfolio_item_layout_type', 'type_1' );


# 2. Colors

$overlay_color = HubitatOptions::get( 'portfolio_grid_overlay_color' );
...
$video_btn_color = HubitatOptions::get( 'portfolio_grid_video_btn_bg' );
if ( $video_btn_color ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $video_btn_color_css );
}

$slider_nav_color_css = HubitatOptions::get( 'portfolio_nav_color' );
if ( $slider_nav_color_css ) {
	$slider_nav_color_css = 'color:' . $slider_nav_color_css . ';';
	$_selector = [
		'.clb-slider-nav-btn .btn-round-light .ion'
	];
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $slider_nav_color_css );
}

$slider_bullets_color_css = HubitatOptions::get( 'portfolio_bullets_color' );
if ( $slider_bullets_color_css && $slider_bullets_color_css != 1) {
	$slider_bullets_color_css = 'color:' . $slider_bullets_color_css . ';';
	$_selector = [
		'.clb-slider-pagination .clb-slider-page'
	];
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $slider_bullets_color_css );
}

$background_color = HubitatOptions::get( 'portfolio_grid_background_color' );
if ( $background_color ) {
	$background_color_css = 'background-color:' . $background_color . ';';
}

$lightbox_trigger_color = HubitatOptions::get( 'lightbox_trigger_color' );
if ( $lightbox_trigger_color ) {
	$lightbox_trigger_color_css = 'color:' . $lightbox_trigger_color . ';';
}

$description_overlay_color = HubitatOptions::get( 'portfolio_grid_description_overlay_color' );
...
if ($overlay_gradient_color_css) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $overlay_gradient_color_css );
}
...
if ( $background_color_css ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $background_color_css );
}
...
if ( $lightbox_trigger_color_css ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $lightbox_trigger_color_css );
}
...
if ( $description_overlay_color_css ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $description_overlay_color_css );
}

// title typo
$title_typo = HubitatOptions::get_global( 'portfolio_title_typo' );
...
// category typo
$category_typo = HubitatOptions::get_global( 'portfolio_category_typo' );
$category_typo_css = HubitatHelper::parse_acf_typo_to_css( $category_typo );
if ( $category_typo_css ) {
	$_selector = [
		'.portfolio-item .category',
		'.portfolio-item .show-project-link'
	];
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $category_typo_css );
}

// Short Description typo
if( $projects_layout_item != 'grid_1' && $projects_layout_item != 'grid_2' ) {
	$project_short_desc_typo = HubitatOptions::get_global( 'portfolio_descr_typo' );
	$project_short_desc_typo_css = HubitatHelper::parse_acf_typo_to_css( $project_short_desc_typo );
	$_selector = '.portfolio-item-fullscreen .portfolio-details-description .short-description';
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $project_short_desc_typo_css );

	$portfolio_date_typo = HubitatOptions::get_global( 'portfolio_date_typo' );
	$portfolio_date_typo_css = HubitatHelper::parse_acf_typo_to_css( $portfolio_date_typo );
	$_selector = '.portfolio-item-fullscreen .portfolio-details-date';
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $portfolio_date_typo_css );
}

// "View Project" link typo
$project_link_typo = HubitatOptions::get_global( 'portfolio_show_more_button_typo' );
$project_link_typo_css = HubitatHelper::parse_acf_typo_to_css( $project_link_typo );
$_selector = [
		'.portfolio-details-link .btn',
		'.portfolio-details-link .btn .ion',
		'.portfolio-item-fullscreen .portfolio-details-link .btn'
	];
HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $project_link_typo_css );

// lightbox categories typo
$lightbox_title_typo = HubitatOptions::get_global( 'lightbox_category_typo' );
$lightbox_title_typo_css = HubitatHelper::parse_acf_typo_to_css( $lightbox_title_typo );
if ( $lightbox_title_typo_css ) {
	$_selector = '.clb-portfolio-lightbox .category';
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $lightbox_title_typo_css );
}

// lightbox title typo
$lightbox_title_typo = HubitatOptions::get_global( 'lightbox_title_typo' );
$lightbox_title_typo_css = HubitatHelper::parse_acf_typo_to_css( $lightbox_title_typo );
if ( $lightbox_title_typo_css ) {
...
$lightbox_title_typo = HubitatOptions::get_global( 'lightbox_description_typo' );
$lightbox_title_typo_css = HubitatHelper::parse_acf_typo_to_css( $lightbox_title_typo );
if ( $lightbox_title_typo_css ) {
...
$lightbox_details_typo = HubitatOptions::get_global( 'lightbox_details_typo' );
$lightbox_details_typo_css = HubitatHelper::parse_acf_typo_to_css( $lightbox_details_typo );
if ( $lightbox_details_typo_css ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $lightbox_details_typo_css );
}

// lightbox link typo
$lightbox_link_typo = HubitatOptions::get_global( 'lightbox_link_typo' );
$lightbox_link_typo_css = HubitatHelper::parse_acf_typo_to_css( $lightbox_link_typo );
$_selector = '.clb-portfolio-lightbox .btn';
HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $lightbox_link_typo_css );

// lightbox date typo
$lightbox_date_typo = HubitatOptions::get_global( 'lightbox_date_typo' );
$lightbox_date_typo_css = HubitatHelper::parse_acf_typo_to_css( $lightbox_date_typo );
$_selector = '.clb-portfolio-lightbox .date';
HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $lightbox_date_typo_css );