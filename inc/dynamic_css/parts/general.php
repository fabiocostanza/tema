...
$brand_color = HubitatOptions::get_global( 'page_brand_color' );
if ( $brand_color ) {
    $_selector = [
        '.brand-color',
        '.brand-color-i',
...
$selection_color = HubitatOptions::get_global( 'page_selection_color' );
if ( $selection_color ) {
...
$links_color = HubitatOptions::get_global( 'page_links_color' );
if ( $links_color ) {
...
$borders_color = HubitatOptions::get_global( 'page_borders_color' );
if ( $borders_color ) {
...
$backgrounds_color = HubitatOptions::get_global( 'page_backgrounds_color' );
...
$dark_mode_background = HubitatOptions::get_global( 'page_dark_mode_background_color' );
...
if ( $selection_css ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $selection_css );
}
...
if ( $links_css ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $links_css );
}
...
if ( $borders_css ) {
	...
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $borders_css );
}
...
if ( $backgrounds_css ) {
	$_selector = [
		...
		'.single-post .widget_hubitat_widget_about_author',
		'.blog-grid.boxed .blog-grid-content',
		'.portfolio-item-grid.portfolio-grid-type-1.boxed .portfolio-item-details',
		'.site-footer'
	];
	HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $backgrounds_css );
}
...
if ( $dark_mode_background_css ) {
    ...
    HubitatBuffer::pack_dynamic_css_to_buffer( $_selector, $dark_mode_background_css );
}