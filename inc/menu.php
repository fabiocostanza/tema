 ...
 *	Mega Menu 
 */
if ( ! defined( 'STOCKIE_MEGA_MENU_CLASS' ) ) define( 'STOCKIE_MEGA_MENU_CLASS', 'Hubitat_Mega_Menu' );
if ( ! defined( 'STOCKIE_EDIT_MENU_WALKER_CLASS' ) ) define( 'STOCKIE_EDIT_MENU_WALKER_CLASS', 'Hubitat_Edit_Menu_Walker' );
if ( ! defined( 'STOCKIE_NAV_MENU_WALKER_CLASS' ) ) define( 'STOCKIE_NAV_MENU_WALKER_CLASS', 'Hubitat_Nav_Menu_Walker' );
if ( ! function_exists( 'hubitat_mega_menu_init' ) ) {

	function hubitat_mega_menu_init() {
...
add_action( 'after_setup_theme', 'hubitat_mega_menu_init' );

if ( ! function_exists( 'hubitat_mega_menu_walker' ) ) {

	function hubitat_mega_menu_walker( $args = '' ) {
...
add_filter( 'wp_nav_menu_args', 'hubitat_mega_menu_walker' );

function hubitat_megamenu_remove_hoverintent_delay( $array ) {
	$array['interval'] = 0;
	$array['timeout'] = 0;
...
add_filter( 'megamenu_javascript_localisation', 'hubitat_megamenu_remove_hoverintent_delay', 10, 1 );