<?php
	...
	$projects_layout_item = HubitatOptions::get_global( 'project_item_layout_type', 'grid_1' );
	if ( $projects_layout_item != 'grid_2') {
		$projects_layout_item = 'grid_1';
	}

	$project_animation_type = HubitatOptions::get_global( 'portfolio_page_animation_type' );
	$project_animation_effect = HubitatOptions::get_global( 'portfolio_page_animation_effect' );
	$open_in_popup = HubitatOptions::get_global( 'portfolio_projects_in_popup' );
	$metro_style = HubitatOptions::get_global( 'portfolio_metro_style', false );
				...
				global $wp_query;
					...
					while ( have_posts() ) : the_post();
						switch ( $post->post_type ) {
							case 'hubitat_portfolio': // projects
							...
							default: // default post or undefined custom
								...
								$parsed_post = HubitatObjectParser::parse_to_post_object( $post, NULL, $_post_i + 1 );
								$parsed_post['metro_style'] = $metro_style;
