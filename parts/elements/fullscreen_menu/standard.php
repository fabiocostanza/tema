...
$fullscreen_have_social = HubitatOptions::get_global( 'page_hamburger_social_networks_visibility', true );
$fullscreen_have_lang = HubitatOptions::get_global( 'page_hamburger_lang_switcher_visibility', true );
$header_overlay_footer_has_left = have_rows( 'global_page_overlay_menu_footer_items_left', 'option' );
$menu_position = HubitatOptions::get_global( 'page_header_menu_position', 'left', true );
...
<div class="clb-popup hamburger-nav">
    ...
    <div class="hamburger-nav-holder">
        <?php
            $menu = HubitatOptions::get_global( 'page_hamburger_menu' );
            ...
            if ( is_nav_menu( $menu ) ) {
                ...
                if ( has_nav_menu( 'primary' ) ) {
                    ...
                    echo '<span class="menu-blank">' . sprintf(esc_html__( 'Please, %1$sassign a menu%2$s', 'hubitat' ), '<a class="highlighted" target="_blank" href="' . esc_url( home_url( '/' ) ) . 'wp-admin/nav-menus.php">', '</a>' ) . '</span>';
                }
            }
        ?>
    </div>
