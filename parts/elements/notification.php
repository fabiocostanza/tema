<?php
	...
	$notification_button = HubitatOptions::get_global( 'notification_button' );
	$notification_link = HubitatOptions::get_global( 'notification_link' );

	if ( $notification_button ) {
		$notification_button_link = HubitatOptions::get_global( 'notification_button_link' );
	}
		...
		<div class="notification-bar active">
			<div class="notification">
				<div class="notification-text" >
					<?php echo wp_kses( HubitatOptions::get_global( 'notification_text' ), 'post' ) ?>
