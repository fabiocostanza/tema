<?php
	...
	if ( !HubitatOptions::get_global( 'page_preloader_visibility', false ) ) {
		$preloader_classes .= 'hide';
	} else {
		if (HubitatOptions::get_global( 'page_preloader_type', 'classic_circle' ) == 'percentage') {
...
<div class="page-preloader <?php echo esc_attr( $preloader_classes ) ?>" id="page-preloader">
		<?php
			switch ( HubitatOptions::get_global( 'page_preloader_type', 'classic_circle' ) ) {
				case 'classic_circle':
				...
				case 'percentage':
					...
					break;
				case 'custom_loader':
					$preloader = HubitatOptions::get_global( 'custom_page_preloader' );
					if ( $preloader ) {
