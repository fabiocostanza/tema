<?php
    ...
    $wpml_show_in_header = HubitatOptions::get_global( 'wpml_show_in_header', true );
    $header_have_social = have_rows( 'global_header_menu_social_links', 'option' );
    $mobile_social_position = HubitatOptions::get_global( 'page_mobile_header_social_position', 'default' );
    $mobile_menu_position = HubitatOptions::get_global( 'page_mobile_header_menu_position', 'left' );
    $dropdown_carets_visibility = HubitatOptions::get_global( 'page_header_counters_visibility', true );
    $social_icons_mobile = HubitatOptions::get_global( 'page_mobile_social_networks_visibility', true );
    $mobile_menu = HubitatOptions::get_global( 'page_extended_mobile_menu' );
    $mobile_second_click_link = HubitatOptions::get_global( 'page_mobile_second_click_link', false );
    ...
    <div class="mbl-overlay menu-mbl-overlay">
        ...
        <div class="mbl-overlay-container">
            ...
            <div id="mega-menu-wrap" class="nav-container">
                ...
                <?php
                    $menu = HubitatOptions::get_global( 'page_extended_menu' );
                    ...
                    if ( $menu ) {
                        ...
                        if ( has_nav_menu( 'primary' ) ) {
                            ...
                            echo '<span class="menu-blank" id="primary-menu">' . sprintf( esc_html__( 'Please, %1$s assign a menu %2$s', 'hubitat' ), '<a class="highlighted" target="_blank" href="' . esc_url( home_url( '/' ) ) . 'wp-admin/nav-menus.php">', '</a>' ) . '</span>';
                        }
                    }
            ...
            <!-- Copyright -->
            <div class="copyright">
                <?php echo wp_kses( HubitatOptions::get_global( 'footer_copyright_left' ), 'post' ); ?>
                <br>
                <?php echo wp_kses( HubitatOptions::get_global( 'footer_copyright_right' ), 'post' ); ?>
            </div>
