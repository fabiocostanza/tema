<?php
    ...
    if ( HubitatSettings::is_coming_soon_page() ) return;
    ...
    if ( !empty( $scroll_top_content ) ) {
        if ( HubitatOptions::get_global( 'page_arrow_position', 'left' ) == 'left' ) {
    ...
    if ( !empty( $social_networks_content ) ) {
        if ( HubitatOptions::get_global( 'social_network_position', 'right' ) == 'left' ) {
    ...
    if ( !empty( $color_switcher_content ) ) {
        if ( HubitatOptions::get_global( 'page_dark_mode_switcher_position', 'left' ) == 'left' ) {
