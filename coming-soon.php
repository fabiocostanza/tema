...
<section class="clb-coming-soon">
    <div class="holder">
        <h2><?php echo HubitatOptions::get_global( 'coming_soon_heading', __( 'We\'re under construction', 'hubitat' ) ); ?></h2>
        <p>
            <?php echo HubitatOptions::get_global( 'coming_soon_details', __( 'Check back for an update soon.', 'hubitat' ) ); ?>
        </p>

        <?php if ( HubitatOptions::get_global( 'coming_soon_countdown', true ) ): ?>
            <div 
                class="hubitat-countdown-box-sc countdown-box text-center" 
                data-countdown-labels="Months,Days,Hours,Minutes,Seconds" 
                data-countdown-box="template_hubitat-custom-cs" 
                data-countdown-time="<?php echo HubitatOptions::get_global( 'coming_soon_expiration', '2025/03/14 18:00:00' ); ?>">
            </div>

            <script type="text/template" id="template_hubitat-custom-cs">
    ...
    <?php if ( HubitatOptions::get_global( 'coming_soon_switch_social', true ) ): ?>
